    ...
    function Leapyear(){
      ...
      return(
        <div className="leapYear border_box shadow">
          ...
          <input value={inputYear} type="number" onChange={(e) => {setinputYear(e.target.value)}}/>
    ...
    function CalculateBMI(){
      ...
      return(
        <div className="bmi border_box shadow">
          <h1>Check BMI</h1>
          <input type="number" value={inputheight} onChange={(e) => setinputheight(e.target.value)} placeholder="Enter Height"/>
          <br></br>
          <input type="number" value={inputweight} onChange={(e) => setinputweight(e.target.value)} placeholder="Enter Weight"/>
          <br></br>
    ...
    export function Ageband(){
      ...
      return(
        <div className="age border_box shadow">
          <h1>Check AgeBand</h1>
          <input  value={inputAge} onKeyUp={handleAgeBand} onChange={(e) => setinputAge(e.target.value)} placeholder="Enter Age"/>
          <h1>{agecount}</h1>
        </div>
      )
    }
    ...
    export function Guessnumber(){
      ...
      return(
        <div className="guessNum border_box shadow">
          ...
          <input type="number" onChange={(e) => setinputnumtoguess(e.target.value)} value={inputnumtoguess}/>
